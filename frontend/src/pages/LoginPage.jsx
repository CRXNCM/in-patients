...
import loginBackground from '@/asset/background.png'
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-8">
      ...
      <div className="relative z-10 w-full max-w-md">
        <Card className="shadow-2xl border border-white/60 bg-white/95 backdrop-blur-sm">
          <CardHeader className="items-center text-center space-y-3 pb-2">
            <HospitalLogo size="lg" className="mx-auto" />
            <div>
              <CardTitle className="text-lg text-blue-800">{hospitalSettings.name}</CardTitle>
              <CardDescription>InCare · Hospital In-Patient Billing</CardDescription>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <p className="text-center text-xs text-slate-700 mt-6 drop-shadow-sm">
          InCare · {hospitalSettings.name} · Currency: ETB
        </p>
      </div>
    </div>
  )
